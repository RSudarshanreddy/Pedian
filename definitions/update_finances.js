operate("update_finances_from_gsheets")
  .tags("Forecast")
  .queries(`
    MERGE INTO \`sudarshan-442212.dataform.tbl_daily_fin_updates\` AS Target
    USING (
      SELECT            
          Stock,
          Buy_Qty,
    ...
    FROM (
      SELECT A.Stock, B.Buy_Value as Latest_Buy_Value, B.Entity, B.Initial_Qty + B.New_Buy_Qty as Latest_Buy_Qty
